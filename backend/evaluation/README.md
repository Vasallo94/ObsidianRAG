...
Build and evaluate the production v4 engine:

```bash
obsidianrag index --vault evaluation/sample-vault --full-rebuild
obsidianrag evaluate evaluation/questions.json --vault evaluation/sample-vault --k 5
obsidianrag evaluate evaluation/questions.json --vault evaluation/sample-vault --lexical-only --k 5
```
